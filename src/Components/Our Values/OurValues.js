      ...
      <div className="container" data-aos="fade-up">
        ...
        <div className="row">
          <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div className="box">
              <img src="assets/img/ValueImage1.jpg" className="img-fluid" alt="altPictures"/>
              <h3>Our Mission</h3>
          ...
          <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div className="box">
              <img src="assets/img/ValueImage3.jpg" className="img-fluid" alt="altPictures"/>
              <h3>Our Guarantee</h3>
          ...
          <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
            <div className="box">
              <img src="assets/img/ValueImage4.jpeg" className="img-fluid" alt="altPictures"/>
